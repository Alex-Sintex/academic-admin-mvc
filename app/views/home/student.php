...
<body class="hold-transition skin-blue sidebar-mini sidebar-collapse">
   <div class="wrapper">
      ...
      if ($user === 'No enviado' || $user !== '') {
         $html = <<<HTML
                           <!-- MODAL SEND FDC -->
                        <div class="modal fade" id="modalSendFDC"  role="dialog">
                        ...
                        <div class="modal-dialog">
                           <div class="modal-content">
                              ...
                              <div class="modal-header">
                                 ...
                                 <img class="imgFDC" src="../../../../img/LogoDoc.png" alt="header-image"></h4>
                              </div>
                              <!-- Modal body -->
                              <div class="modal-body">
                                    <div class="box box-info">
                                    ...
                                    <form enctype="multipart/form-data" id="fdcForm" class="form-horizontal" method="POST">
                                       <div class="box-body">
                                          ...
                                          <div class="box box-info">
                                             ...
                                             <div class="form-group">
                                                <img class="imgFooter" src="../../../../img/FooterDoc.png" alt="image-footer">
                                             </div>
                                          </div>
                                       </div>
                                 </div><!-- END MODAL BODY -->
   ...
   if (is_array($data['stud_fdc'])) :
      foreach ($data['stud_fdc'] as $stud_fdc) :
         if ($user === 'No enviado' || $user !== '') {
            $html = <<<HTML
                     <!-- EDIT MODAL FDC -->
                     <div class="modal fade" id="editFDC{$stud_fdc->nControl}" data-backdrop="static"  role="dialog">
                        <!-- The Modal -->
                        <div class="modal-dialog">
                           <div class="modal-content">
                              <!-- Modal Header -->
                              <div class="modal-header">
                                 <h4 class="modal-title"><img class="imgFDC" src="../../../../img/LogoDoc.png" alt="header-image"></h4>
                              </div>
                              <!-- Modal body -->
                              <div class="modal-body">
                                 <div class="box box-info">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                   <div class="dropdownC">
                                                      <div class="selectC form-control">
            HTML;
            $html .= '<span id="selected_career">' . (isset($stud_fdc->carrera) ? $stud_fdc->carrera : 'Selecciona tu carrera') . '</span>';
            $html .= <<<HTML
                                      <i class="fa fa-chevron-left"></i>
                                  </div>
            HTML;
            $html .= '<input type="hidden" name="EditcarreraA" value="' . (isset($stud_fdc->carrera) ? $stud_fdc->carrera : 'Carrera no seleccionada') . '">';
            $html .= <<<HTML
                                                      <ul class="dropdown-menuC" name="carreraA">
                                                         <li class="career" id="Ingeniería Industrial">Ingeniería Industrial</li>
                                                         <li class="career" id="Ingeniería en Gestión Empresarial">Ingeniería en Gestión
            ...
            HTML;
            $html .= '<li>' . (!empty(json_decode($stud_fdc->anexos)) ? implode(', ', json_decode($stud_fdc->anexos)) : 'No hay archivos anexados') . '</li>';
            $html .= <<<HTML
                                                         </ul>
                                                      </div>
                                                      <label class="lAnexos" for="upload">
